...
python -m lightx2v.infer \
    ...
    --task i2v \
    --model_path "${model_path}" \
    --config_json "${lightx2v_path}/configs/platforms/amd_rocm/wan22_moe_i2v_bf16_40step_r9600_gfx1201.json" \
    ...
    --save_result_path "${lightx2v_path}/save_results/output_lightx2v_wan22_moe_i2v_bf16_40step_r9600_gfx1201.mp4"
